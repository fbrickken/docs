---
title: 'Prepare Transactions - newInvest'
...
| `stoId` | string | Yes | ID of the STO to invest in |
...
| `paymentTokenSymbol` | string | Yes | Symbol of the payment token (USDT, USDC, etc.) |
