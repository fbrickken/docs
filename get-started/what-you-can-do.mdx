...
- **The CLI cannot call the Dapp API.** No Dapp commands exist, and it only sends an API key on RAMS reads. The [SDK](/sdk/introduction) is the client to use for Dapp work from your own code.
