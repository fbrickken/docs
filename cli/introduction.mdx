...
The **Brickken CLI** is the public terminal client for the [x402 API](/api-reference/endpoint/agentic-methods-x402). It prepares Brickken agentic transactions, signs locally with your private key, pays API requests through x402, and can submit the signed transaction in one command.
