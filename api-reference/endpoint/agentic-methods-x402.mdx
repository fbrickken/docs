---
title: 'Agentic API'
description: 'x402-paid Agentic API for ERC-8004 agent identity, reputation, and agent-token workflows on Base.'
---

## Overview

The Agentic API is the x402-paid surface for Brickken agentic methods. It covers ERC-8004 agent identity, reputation, and agent-owned ERC-20 token operations on **Base mainnet** and **Base Sepolia**.
