...
It is also **the only client that reaches the full Dapp API with nothing but an API key** — 13 read tools and 11 write tools that go through `prepare-transactions`. The CLI cannot do this; see [Choose your surface](/get-started/choose-your-surface).
