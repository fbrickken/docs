...
## A test investor without a KYC document

Sandbox KYC runs against a Sumsub sandbox tenant. For most testing you do not need it at all:
create the investor with KYC not required.
...
If you want to exercise the real KYC flow instead, a sample document image is enough to reach a
green applicant in the Sandbox tenant; no genuine liveness check is required. Never upload real
identity documents to a test account.
