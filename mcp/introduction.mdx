...
The `forge` environment resolves to `https://d4aqanatl1.execute-api.eu-west-1.amazonaws.com/forge`. A custom `baseUrl` still overrides the selected environment when needed.
