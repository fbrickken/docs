...
The Brickken MCP server exposes the Brickken dApp API and x402 agentic API as tools for MCP-compatible AI agents.

<CardGroup cols={2}>
  <Card title="MCP endpoint" icon="plug" href="https://mcp.brickken.com/mcp">
    Connect agents to `https://mcp.brickken.com/mcp`.
  </Card>
...
Use this mode for the [x402 API](/api-reference/endpoint/agentic-methods-x402). The private key is used by the MCP server session for local transaction signing and x402 payment signing.
